        ...
        <ProvisioningNavigator
          config={{
            ble: {
              ...
              scanTimeoutMs: 10000,
              security: 1,
              // The library has no implicit PoP anymore. This is the firmware
              // repo's examples/with_ble value; with promptForAuth it pre-fills
              // the auth screen. Set '' for a device whose firmware runs
              // Security 1 with no PoP; leave unset to force the user to type
              // one (the auth screen still shows because promptForAuth is on).
